...
class _JobDetailContentState extends State<_JobDetailContent> {
  ...
  Future<void> _navigateToRatingPage(
    ...
    try {
      final requestId = (data?['requestId'] ?? widget.requestId)?.toString();
      ...
      try {
        final snap =
            await FirebaseFirestore.instance
                ...
                .where('requestId', isEqualTo: requestId.trim())
                .limit(1)
                .get();
      ...
      // Fallback: navigate to home if AssignedJobs entry not found
      Navigator.pushNamedAndRemoveUntil(
        context,
        '/skilled-worker-home',
        (route) => false,
